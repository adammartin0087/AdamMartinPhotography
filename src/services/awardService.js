export function getAwards() {
  return [
    {
      name: "Ocean Art 2019",
      position: "3rd Place - Wide Angle",
      imageUrl: "Wide-Angle3_Adam_Martin_Eye_of_the_Hurricane_copy-min",
